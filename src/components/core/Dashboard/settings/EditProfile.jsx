  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 text-richblack-5 p-5 sm:p-8 px-4 sm:px-12">
        ...
        <div className="flex justify-end -mt-5 gap-2">
          ...
          <button className="yellow-btn" type="submit">Save</button>
        </div>
      </form>
    </>
  )
